  <?php  if(isset($_GET['id'])){
        $sql_cek = "SELECT * FROM kabid as a, bidang as b WHERE  a.id_bidang=b.id_bidang and a.id_kabid='".$_GET['id']."'";
  ...
  <div class="main-panel">
          <div class="content-wrapper">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="id" value="<?=$data_cek['id_kabid'];?>">
                                <div class="form-group">
                        <label for="exampleInputName1">NIP</label>
                        <input type="text"  name="nip" class="form-control" id="exampleInputName1" value="<?= $data_cek['nip'];?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text"  name="jabatan" class="form-control" id="exampleInputName1" value="<?= $data_cek['jabatan'];?>">
                      </div>
                      <div class="form-group">
            ...
            while($ma=mysqli_fetch_array($kabid)){
                    ...
                    <?php } ?>
                      <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                          <img src="../images/kabid/<?= $data_cek['foto'];?>" style="width: 100px; height:100px;">
...
if (isset($_POST['simpan'])){
  ...
  if (empty($foto) && empty($pp)){
    $koneksi->query("UPDATE kabid SET 
                    nama     = '$_POST[nama]',
    ...
    $hapus= $koneksi->query("select * from kabid where id_kabid='$_POST[id]'");
    $tanggal_foto=mysqli_fetch_array($hapus,MYSQLI_BOTH);
    $lokasi=$tanggal_foto['foto'];
    $hapus_foto="../images/kabid/$lokasi";
    unlink($hapus_foto);
    move_uploaded_file($_FILES['foto']['tmp_name'],'../images/kabid/'.$foto);
    $koneksi->query("UPDATE kabid SET nama     = '$_POST[nama]',
                    username     = '$_POST[username]',
                    id_bidang = '$_POST[id_bidang]',
                    nip = '$nip',
                    jabatan = '$jabatan',
  ...
  if($_SESSION['level']=="Kepala Bidang"){
    echo"<script>alert('Selamat Data Berhasil di Ubah!!!'); window.location = '?page=page/kabid/edit&id=$_SESSION[id]&data=Update Profil'</script>";
  
  

}else{
echo"<script>alert('Selamat Data Berhasil di Ubah!!!'); window.location = '?page=page/kabid/index&id=Data Kepala Bidang Pengaduan'</script>";
   }
    }
