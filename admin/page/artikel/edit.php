  <?php  if(isset($_GET['id'])){
        $sql_cek = "SELECT * FROM artikel  WHERE  id_artikel='".$_GET['id']."'";
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="id" value="<?=$data_cek['id_artikel'];?>">
                      ...
                      <div class="form-group">
                        ...
                        <textarea type="text" name="keterangan" class="form-control" id="exampleInputEmail3"><?= $data_cek['keterangan'];?></textarea> 
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                          <img src="../images/artikel/<?= $data_cek['foto'];?>" style="width: 100px; height:100px;">
...
if (isset($_POST['simpan'])){
  ...
  if (empty($foto)){
    ...
    $hapus= $koneksi->query("select * from artikel where id_artikel='$_POST[id]'");
    $tanggal_foto=mysqli_fetch_array($hapus,MYSQLI_BOTH);
    $lokasi=$tanggal_foto['foto'];
    $hapus_foto="../images/artikel/$lokasi";
    unlink($hapus_foto);
    move_uploaded_file($_FILES['foto']['tmp_name'],'../images/artikel/'.$foto);
    $koneksi->query("UPDATE artikel SET judul     = '$judul',
                    keterangan     = '$keterangan',
                    foto  = '$foto'
                    WHERE id_artikel= '$_POST[id]'");
  }
echo"<script>alert('Data Berhasil di Ubah!!!'); window.location = '?page=page/artikel/index&id=Data artikel'</script>";
    }
