                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text"  name="nama_bidang" class="form-control" id="exampleInputName1" placeholder="Nama Bidang Pengaduan">
                      </div>
...
<?php
    ...
    if ($query_simpan) {
      echo"<script>alert('Data bidang Berhasil di tambah !!!'); window.location = '?page=page/bidang/index&id=Data Bidang Pengaduan'</script>";
      }else{
      echo"<script>alert('Data bidang Gagal di Simpan !!!'); window.location = '?page=page/bidang/tambah'</script>";
    }}?>